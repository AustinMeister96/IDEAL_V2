    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("year_moved_to_canada", models.TextField(max_length=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("inclusion_criteria_1", models.BooleanField(blank=True, null=True)),
                ("inclusion_criteria_2", models.BooleanField(blank=True, null=True)),
                ("inclusion_criteria_3", models.BooleanField(blank=True, null=True)),
                ("inclusion_criteria_4", models.BooleanField(blank=True, null=True)),
                ("inclusion_criteria_5", models.BooleanField(blank=True, null=True)),
                ("inclusion_criteria_6", models.BooleanField(blank=True, null=True)),
                ("inclusion_criteria_7", models.BooleanField(blank=True, null=True)),
                ("inclusion_criteria_8", models.BooleanField(blank=True, null=True)),
                ("inclusion_criteria_9", models.BooleanField(blank=True, null=True)),
                ("inclusion_criteria_9_a", models.BooleanField(blank=True, null=True)),
                ("inclusion_criteria_9_b", models.BooleanField(blank=True, null=True)),
                ("inclusion_criteria_9_c", models.BooleanField(blank=True, null=True)),
                ("inclusion_criteria_9_d", models.BooleanField(blank=True, null=True)),
                (
                    "inclusion_status",
                    models.TextField(
                        blank=True,
