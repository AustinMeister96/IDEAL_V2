...
class lab_processing(models.Model):
    ...
    participant_num = models.ForeignKey(Participant, on_delete=models.CASCADE)
    reciva_tennax = models.IntegerField(max_length=6)
    ...
    room_air_tennax = models.IntegerField(max_length=6)
    ...
    casper_tennax = models.PositiveIntegerField(max_length=6)
...
class Exposure2(models.Model):
    ...
    cooking_location = models.TextField(max_length=44, choices=cooking_location_choices, blank=True, null=True)
...
class Mandatory_questionaire(models.Model):
    ...
    ethnicity = models.TextField(max_length=20, choices=ethnicity, null=True, blank=True)
    ...
    biological_relatives_cancer = models.BooleanField( null=True, blank=True)
...
class inclusion(models.Model):
    ...
    inclusion_criteria_9_a = models.BooleanField()
    inclusion_criteria_9_b = models.BooleanField()
    inclusion_criteria_9_c = models.BooleanField()
    inclusion_criteria_9_d = models.BooleanField()
